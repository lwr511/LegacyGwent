...
namespace Assets.Script.DynamicCards.Editor
{
    public static class DynamicCardTextureCompression
    {
        ...
        {
            if (!path.StartsWith(DynamicCardLibrary.ContentRoot + "Latest/", StringComparison.Ordinal) ||
        ...
        public static void Apply()
        {
            ...
            try
            {
                foreach (var path in Directory.GetFiles(DynamicCardLibrary.ContentRoot + "Latest", "*.png", SearchOption.AllDirectories))
