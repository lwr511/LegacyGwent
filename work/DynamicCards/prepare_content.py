...
old_cards=json.loads(Path(r'<USER_HOME>/Documents/Codex/2026-09-05/c-steamlibrary-steamapps-common-thronebreaker-the/outputs/ThronebreakerGodot/assets/cards.json').read_text(encoding='utf8'))
