...
(w/'legacy-controller-audit.json').write_text(json.dumps({'checked':checked,'issues':issues},indent=2));print('controllers',checked,'issues',len(issues));print(issues[:10])
