...
entry = next(c for c in data['cards'] if '11210700' in c['artIds'])
assert entry == plan['previous'] and entry['id'] == '11210701'
...
print('PASS: restored 38 assets and the Latest/10130101 mapping; existing source partitions retained.')
