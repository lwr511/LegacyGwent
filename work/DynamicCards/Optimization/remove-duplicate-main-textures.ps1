...
$expected='C:\UnityProjects\LegacyGwent\src\Cynthia.Card.Unity\src\Cynthia.Unity.Card\Assets\DynamicCards\Content\Latest'
...
$probe='C:\UnityProjects\LegacyGwent\src\Cynthia.Card.Unity\src\Cynthia.Unity.Card'
