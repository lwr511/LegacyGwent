...
inventory=json.loads((root/'second_source_inventory.json').read_text())
env=UnityPy.load(str(Path(inventory['source'])/'textures/standard/high'))
...
(root/'second_source_matches.json').write_text(json.dumps(result,indent=2))
