...
(r/'client_editor_manifest_snapshot.json').write_text(json.dumps(dict(files=files,created=datetime.datetime.now(datetime.timezone.utc).isoformat()),separators=(',',':')))
print('CLIENT_MANIFEST_SNAPSHOT',len(files),flush=True)
