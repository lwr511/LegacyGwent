param(
    ...
    [string]$MongoUri = 'mongodb://127.0.0.1:28020/gwentdiy',
    [string]$MongoShell = ''
)
...
if ([string]::IsNullOrWhiteSpace($MongoShell)) {
    $MongoShell = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot '../work/LocalServer/mongodb/mongodb-win32-x86_64-2012plus-4.2.25/bin/mongo.exe'))
}
